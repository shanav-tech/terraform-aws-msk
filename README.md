...
```hcl
module "kafka" {
  source              = "git::https://github.com/shanav-tech/terraform-aws-msk?ref=v1.0.0"
...
## Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/shanav-tech/terraform-aws-msk/tree/master/_example) directory within this repository.

## License
This Terraform module is provided under the **MIT** License. Please see the [LICENSE](https://github.com/shanav-tech/terraform-aws-msk/blob/master/LICENSE) file for more details.
